...
//       // หากตรวจสอบผ่าน ให้ส่ง Notification และปิด Modal
//       const amount = response.data.amount; 
//       const user_id = selectedItem.user_id;

//       await axios.post("http://localhost:3000/notifications", {
//         user_id,
//         notification: `You have received ${amount} THB for the exchange transaction. Thank you for using our service.`,
//       });
